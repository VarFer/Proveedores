...
<head>
    ...
    <style>
        ...
        .table-striped tbody tr:nth-of-type(odd) {
            background-color: rgba(255, 255, 255, 0.05); /* Fondo blanco semi-transparente para filas impares */
        }
        .table-striped tbody tr:nth-of-type(even) {
            background-color: rgba(255, 255, 255, 0.1); /* Fondo blanco semi-transparente para filas pares */
        }
...
<body>
    <div class="container">
        ...
        <div class="color-box">
            ...
            <a href="ListarProveedoresServlet" class="btn btn-primary mt-3">Listar Proveedores</a>
        </div>
                ...
                <tbody>
                    ...
                    <c:forEach items="${proveedores}" var="proveedor">
                        <tr>
                            ...
                            <td>
                                <a href="EditarProveedorServlet?id=${proveedor.id}" class="btn btn-warning btn-sm">Editar</a>
                                <form action="EliminarProveedorServlet" method="post" style="display: inline;">
